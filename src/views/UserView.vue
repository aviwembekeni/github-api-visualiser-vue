        ...
        <table >
          ...
          <tbody>
            <tr>
              ...
              <td><RouterLink :to="{ name: 'following', params: {username} }">Number of following</RouterLink></td>
              <td><RouterLink :to="{ name: 'repos', params: {username} }">Number of repos</RouterLink></td>
              <td><RouterLink :to="{ name: 'gists', params: {username} }">Number of gists</RouterLink></td> -->
